<?php
     ...
     Redux::setSection( $opt_name, array(
       ...
       'fields'           => array(
         ...
         array(
           ...
           'type'     => 'typography',
           'title'    => esc_html__( 'Portfolio Filters', 'salient' ),
           'subtitle' => esc_html__( 'Specify the Portfolio filter font properties.', 'salient' ),
           'google'   => true,
           'fonts' =>  $nectar_std_fonts,
           'all_styles'  => false,
           'default'  => array()
     ...
     Redux::setSection( $opt_name, array(
       ...
       'fields'           => array(
         ...
         array(
           ...
           'required' => array( 'header_format', '!=', 'centered-menu-bottom-bar' ),
           'default' => '1' ,
           'hint' => array('content' => esc_html__('This will only be active when the','salient') .'<b> ' . esc_html__('Header Hide Until Needed') . '</b> ' . esc_html__('effect is turned off', 'salient'), 'title' => ''),
         ), 
         array(
    ...
    if ( file_exists( dirname( __FILE__ ) . '/../README.md' ) ) {
        $section = array(
            'icon'   => 'el el-list-alt',
            'title'  => esc_html__( 'Documentation', 'salient' ),
            'fields' => array(
                array(
                    'id'       => '17',
                    'type'     => 'raw',
