...
class Salient_Portfolio {
	...
	public function salient_portfolio_enqueue_scripts() {
			...
			wp_register_script( 'imagesLoaded', plugins_url('/js/third-party/imagesLoaded.min.js', __FILE__), 'jquery', '4.1.4', true );
			wp_register_script( 'isotope', plugins_url('/js/third-party/isotope.min.js', __FILE__), 'jquery', '7.6', true );
			...
			wp_register_script( 'salient-portfolio-waypoints', plugins_url('/js/third-party/waypoints.js', __FILE__), 'jquery', '4.0.1', true );
			wp_register_script( 'salient-portfolio-js', plugins_url('/js/salient-portfolio.js', __FILE__), 'jquery', $this->plugin_version, true );
