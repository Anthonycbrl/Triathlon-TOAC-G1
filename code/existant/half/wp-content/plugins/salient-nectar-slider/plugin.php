...
class Salient_Nectar_Slider {
	...
	public function salient_nectar_slider_enqueue_scripts() {
			...
			wp_register_script( 'nectar-slider', plugins_url('/js/nectar-slider.js', __FILE__), 'jquery', $this->plugin_version, true );
			wp_register_script( 'anime', plugins_url('/js/anime.js', __FILE__), 'jquery', $this->plugin_version, true );
