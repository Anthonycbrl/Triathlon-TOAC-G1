...
class Salient_Shortcodes {
	...
	public function salient_shortcodes_enqueue_js() {
			...
			wp_register_script('salient-shortcodes', plugins_url('/js/init.js', __FILE__),'jquery', $this->plugin_version );
			...
			if( ! defined( 'NECTAR_THEME_NAME' ) && ! class_exists( 'Salient_Core' ) ) {
				...
				wp_register_script( 'touchswipe', plugins_url('/js/touchswipe.min.js', __FILE__), 'jquery', '1.0', true );
